...
namespace TTAPI_Samples
{
	...
	public class AboutDTS : System.Windows.Forms.Form
	{
		...
		public AboutDTS()
		{
			...
			this.textVersionDate.Text = "October 30, 2013";
			this.textAuthors.Text = "Josh Bramlett";
		}
		...
		{
            System.Diagnostics.Process.Start("https://developer.tradingtechnologies.com");
		}

		private void linkLabelWWW_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			System.Diagnostics.Process.Start("https://www.tradingtechnologies.com");		
		}
